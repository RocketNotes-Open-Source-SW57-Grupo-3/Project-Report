...
|E16|Identity and Access Management|<p>Como desarrollador</p><p>Quiero gestionar las identidades de los usuarios y acceder a través de una API RESTful</p><p>Para poder garantizar un manejo seguro, consistente y eficiente de la información y los permisos del usuario dentro del sistema.</p><p></p>|||
...
|TS24|Update a Facility through a RESTful API|<p>As a developer</p><p>I want to update a facility through the API</p><p>So that I can modify existing facility details as needed for ongoing management.</p>|<p>***Scenario: Update facility successfully***</p><p>**Given** the endpoint /api/v1/facilities/{facilityId} is available</p><p>**When** a PUT request is sent with updated values for name, location, and capacity to /api/v1/facilities/{facilityId}</p><p>**Then** a response is received with status 200</p><p>**And** the Facility Resource in the Response Body reflects the updated values for name, location, and capacity.</p><p>***Scenario: Update non-existing facility***</p><p>**Given** the endpoint /api/v1/facilities/{facilityId} is available</p><p>**When** a PUT request is sent with values for a non-existing facilityId</p><p>**Then** a response is received with status 404</p><p>**And** a message is included in the Response Body, stating "Facility not found."</p><p></p>|E10|
|TS25|Delete a Facility through a RESTful API|<p>**As** a developer</p><p>**I want** to delete a facility through the API</p><p>**So that** I can remove facilities that are no longer in use or needed.</p>|<p>***Scenario: Delete facility successfully***</p><p>Given the endpoint /api/v1/facilities/{facilityId} is available</p><p>When a DELETE request is sent to /api/v1/facilities/{facilityId}</p><p>Then a response is received with status 204</p><p>And no content is included in the Response Body, indicating successful deletion.</p><p>***Scenario: Attempt to delete non-existing facility***</p><p>Given the endpoint /api/v1/facilities/{facilityId} is available</p><p>When a DELETE request is sent for a non-existing facilityId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "Facility not found."</p><p></p>|E10|
...
|TS26|Update Equipment through a RESTful API|<p>**As** a developer</p><p>**I want** to update equipment details through the API</p><p>**So that** I can modify existing equipment details to reflect changes or corrections as needed</p>|<p>***Scenario: Update equipment successfully***</p><p>Given the endpoint /api/v1/equipments/{equipmentId} is available</p><p>When a PUT request is sent with updated values for name, type, and serial number to /api/v1/equipments/{equipmentId}</p><p>Then a response is received with status 200</p><p>And the Equipment Resource in the Response Body reflects the updated values for name, type, and serial number.</p><p>***Scenario: Update non-existing equipment***</p><p>Given the endpoint /api/v1/equipments/{equipmentId} is available</p><p>When a PUT request is sent with values for a non-existing equipmentId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "Equipment not found."</p><p></p>|E10|
|TS27|Delete Equipment through a RESTful API|<p>**As** a developer</p><p>**I want** to delete equipment through the API</p><p>**So that** I can remove equipment that is no longer in use or obsolete from the inventory.</p>|<p>***Scenario: Delete equipment successfully***</p><p>Given the endpoint /api/v1/equipments/{equipmentId} is available</p><p>When a DELETE request is sent to /api/v1/equipments/{equipmentId}</p><p>Then a response is received with status 204</p><p>And no content is included in the Response Body, indicating successful deletion.</p><p>***Scenario: Attempt to delete non-existing equipment***</p><p>Given the endpoint /api/v1/equipments/{equipmentId} is available</p><p>When a DELETE request is sent for a non-existing equipmentId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "Equipment not found."</p><p></p>|E10|
...
|TS28|Update a Student through a RESTful API|<p>**As** a developer</p><p>**I want** to update student details through the API</p><p>**So that** I can modify existing student records to reflect changes such as transfers, grade updates, or corrections.</p>|<p>***Scenario: Update student successfully***</p><p>Given the endpoint /api/v1/students/{studentId} is available</p><p>When a PUT request is sent with updated values for name, age, and address to /api/v1/students/{studentId}</p><p>Then a response is received with status 200</p><p>And the Student Resource in the Response Body reflects the updated values for name, age, and address.</p><p>***Scenario: Update non-existing student***</p><p>Given the endpoint /api/v1/students/{studentId} is available</p><p>When a PUT request is sent with values for a non-existing studentId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "Student not found."</p><p></p>|E11|
|TS29|Delete a Student through a RESTful API|<p>**As** a developer</p><p>**I want** to delete a student from the system through the API</p><p>**So that** I can remove records of students who are no longer attending or have graduated.</p>|<p>***Scenario: Delete student successfully***</p><p>Given the endpoint /api/v1/students/{studentId} is available</p><p>When a DELETE request is sent to /api/v1/students/{studentId}</p><p>Then a response is received with status 204</p><p>And no content is included in the Response Body, indicating successful deletion.</p><p>***Scenario: Attempt to delete non-existing student***</p><p>Given the endpoint /api/v1/students/{studentId} is available</p><p>When a DELETE request is sent for a non-existing studentId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "Student not found."</p><p></p>|E11 |
...
|TS30|Update a Teacher through a RESTful API|<p>**As** a developer</p><p>**I want** to update teacher details through the API</p><p>**So that** I can modify existing teacher records to reflect changes such as role changes, department transfers, or corrections.</p>|<p>***Scenario: Update teacher successfully***</p><p>Given the endpoint /api/v1/teachers/{teacherId} is available</p><p>When a PUT request is sent with updated values for name, specialty, and email to /api/v1/teachers/{teacherId}</p><p>Then a response is received with status 200</p><p>And the Teacher Resource in the Response Body reflects the updated values for name, specialty, and email.</p><p>***Scenario: Update non-existing teacher***</p><p>Given the endpoint /api/v1/teachers/{teacherId} is available</p><p>When a PUT request is sent with values for a non-existing teacherId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "Teacher not found."</p><p></p>|E11|
|TS31|Delete a Teacher through a RESTful API|<p>**As** a developer</p><p>**I want** to delete a teacher from the system through the API</p><p>**So that** I can remove records of teachers who are no longer employed or have retired.</p>|<p>***Scenario: Delete teacher successfully***</p><p>Given the endpoint /api/v1/teachers/{teacherId} is available</p><p>When a DELETE request is sent to /api/v1/teachers/{teacherId}</p><p>Then a response is received with status 204</p><p>And no content is included in the Response Body, indicating successful deletion.</p><p>***Scenario: Attempt to delete non-existing teacher***</p><p>Given the endpoint /api/v1/teachers/{teacherId} is available</p><p>When a DELETE request is sent for a non-existing teacherId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "Teacher not found."</p><p></p>|E11|
...
|TS32|Delete an Admin through a RESTful API|<p>**As** a developer</p><p>**I want** to delete an admin from the system through the API</p><p>**So that** I can remove records of admins who are no longer employed or have left the organization.</p>|<p>***Scenario: Delete admin successfully***</p><p>Given the endpoint /api/v1/admins/{adminId} is available</p><p>When a DELETE request is sent to /api/v1/admins/{adminId}</p><p>Then a response is received with status 204</p><p>And no content is included in the Response Body, indicating successful deletion.</p><p>***Scenario: Attempt to delete non-existing admin***</p><p>Given the endpoint /api/v1/admins/{adminId} is available</p><p>When a DELETE request is sent for a non-existing adminId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "Admin not found."</p><p></p>|E11|
...
|TS33|Add a User through a RESTful API|<p>**As** a developer</p><p>**I want** to add user details through the API</p><p>**So that** I can register new users and allow them to access system features based on their roles.</p>|<p>***Scenario: Add user successfully***</p><p>Given the endpoint /api/v1/users is available</p><p>When a POST request is sent with user details including name, email, and role</p><p>Then a response is received with status 201</p><p>And the User Resource is included in the Response Body, with a new ID and the registered values for name, email, and role.</p><p>***Scenario: Add user with an existing email***</p><p>Given the endpoint /api/v1/users is available</p><p>When a POST request is sent with an email that already exists in the system</p><p>Then a response is received with status 400</p><p>And a message is included in the Response Body, stating "User cannot be created: email already exists."</p><p></p>|E16|
|TS34|Update a User through a RESTful API|<p>**As** a developer</p><p>**I want** to update user details through the API</p><p>**So that** I can modify user information such as email, name, or role to ensure current and accurate data.</p>|<p>***Scenario: Update user successfully***</p><p>Given the endpoint /api/v1/users/{userId} is available</p><p>When a PUT request is sent with updated values for name, email, and role to /api/v1/users/{userId}</p><p>Then a response is received with status 200</p><p>And the User Resource in the Response Body reflects the updated values.</p><p>***Scenario: Update non-existing user***</p><p>Given the endpoint /api/v1/users/{userId} is available</p><p>When a PUT request is sent for a non-existing userId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "User not found."</p><p></p>|E16|
|TS35|Delete a User through a RESTful API|<p>**As** a developer</p><p>**I want** to delete a user from the system through the API</p><p>**So that** I can manage user lifecycle and remove access when no longer needed.</p>|<p>***Scenario: Delete user successfully***</p><p>Given the endpoint /api/v1/users/{userId} is available</p><p>When a DELETE request is sent to /api/v1/users/{userId}</p><p>Then a response is received with status 204</p><p>And no content is included in the Response Body, indicating successful deletion.</p><p>***Scenario: Attempt to delete non-existing user***</p><p>*Given the endpoint /api/v1/users/{userId} is available*</p><p>*When a DELETE request is sent for a non-existing userId*</p><p>*Then a response is received with status 404*</p><p>*And a message is included in the Response Body, stating "User not found."*</p>|E16|
|TS36|Get a User by ID through a RESTful API|<p>**As** a developer</p><p>**I want** to retrieve user details by their ID through the API</p><p>**So that** I can access specific user information for review or management purposes.</p>|<p>***Scenario: Get existing user by ID***</p><p>Given the endpoint */api/v1/users/{userId}* is available</p><p>When a GET request is sent with a valid userId</p><p>Then a response is received with status 200</p><p>And the User Resource corresponding to the userId is included in the *Response Body.*</p><p>***Scenario: Get non-existing user by ID***</p><p>Given the endpoint */api/v1/users/{userId}* is available</p><p>When a GET request is sent with a non-existing userId</p><p>Then a response is received with status 404</p><p>And a message is included in the Response Body, stating "User not found."</p>|E16|
...
<tr><td>T2</td><td valign="top">Navbar Responsive</td><td valign="top">Hacer el navbar responsive</td><td>0\.5</td><td>Nelson</td><td valign="top">Done</td></tr>
<tr><td>T3</td><td valign="top">Home</td><td valign="top">Hacer el Home </td><td>1</td><td>Mateo</td><td valign="top">Done</td></tr>
<tr><td>T4</td><td valign="top"><p>Home</p><p>Responsive</p></td><td valign="top">Hacer el Home responsive</td><td>0\.5</td><td>Nelson</td><td valign="top">Done</td></tr>
<tr><td>T5</td><td valign="top"><p>Características del Producto</p><p></p></td><td valign="top">Hacer el article de características del producto</td><td>0\.5</td><td>Frida</td><td valign="top">Done</td></tr>
<tr><td>T6</td><td valign="top">Article Responsive</td><td valign="top">Hacer el article de características del producto responsive</td><td>1</td><td>Frida</td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">E5-US21</td><td rowspan="2" valign="top">Confirmación de la Confiabilidad a través de Reseñas</td><td rowspan="2">T7</td><td valign="top">Article Reviews</td><td valign="top">Hacer el article de reviews</td><td>0\.5</td><td>Nelson</td><td valign="top">Done</td></tr>
<tr><td valign="top"><p>Article Reviews</p><p>Responsive</p></td><td valign="top">Hacer el article de reviews responsive</td><td>0\.5</td><td>Nelson</td><td valign="top">Done</td></tr>
...
<tr><td rowspan="2" valign="top">E5-US23</td><td rowspan="2" valign="top">Facilidad de Contacto con la Empresa</td><td>T10</td><td valign="top">Article Contact</td><td valign="top">Hacer el article de contact</td><td>0\.5</td><td>Andre</td><td valign="top">Done</td></tr>
<tr><td>T11</td><td valign="top"><p>Article Contact</p><p>Responsive</p><p></p></td><td valign="top">Hacer el article de contact responsive</td><td>0\.5</td><td>Andre</td><td valign="top">Done</td></tr>
<tr><td valign="top">E5-US24</td><td valign="top">Navegación Intuitiva en la Landing Page</td><td>T12</td><td valign="top">UI Elements</td><td valign="top">Optimización de elementos UI de la landing page</td><td>1</td><td>Nelson</td><td valign="top">Done</td></tr>
<tr><td valign="top">E5-US25</td><td valign="top">Selección de Idioma en la Landing Page</td><td>T13</td><td valign="top">Language</td><td valign="top">Cambiar algunos detalles de la web de español a ingles</td><td>1</td><td>Nelson</td><td valign="top">Done</td></tr>
</table>
...
![](assets/Aspose.Words.47b49ff5-366e-410c-8228-c5a642d265c4.011.png)
...
A continuación, se describe el sprint planning 2, durante el cual se exhibirán pruebas de la planificación y ejecución de la Aplicación Web. Además, se demostrarán los progresos alcanzados en el proyecto y se proporcionarán detalles sobre la colaboración del equipo utilizando Github.

|Sprint #|Sprint 2|
| :- | :- |
|Sprint Planning Background||
|Date|` `28 de abril del 2024|
|Time|11:55 horas (GMT -5)|
|Location|Modalidad remota por Whatssap|
|Prepared By|FiveStars|
|Attendees (to planning meeting)|Todos los miembros del grupo FiveStars|
|Sprint n – 1 Review Summary|Se continuó avanzando en las tareas que estaban en proceso del Sprint 1, abordando secciones pendientes y ajustes de responsividad en la interfaz.|
|Sprint n – 1 Retrospective Summary|Se concluyó el desarrollo del Landing Page Responsive.|
|Sprint Goal & User Stories||
|Sprint 2 Goal|<p>El objetivo principal para este sprint es terminar el Landing Page Responsive y empezar con el desarrollo de la Aplicación Web. Se discutirá el contenido de los textos dentro del landing page y se revisará el diseño previamente implementado en Figma. Al finalizar este sprint, el landing page debe estar completamente responsivo y publicado en Github Pages, además de lograr un avance significativo en el desarrollo inicial de nuestra Aplicación Web.</p><p></p>|
|Sprint 1 Velocity|4|
|Sum of Story Points|4|
...
<tr><td rowspan="2">T3</td><td rowspan="2" valign="top">Crear un curso (Dentro de un salón)</td><td rowspan="2">Funcionalidad de crear un curso para las clases</td><td rowspan="2">2</td><td rowspan="2">Frida</td><td rowspan="2" valign="top">Done</td><td></td></tr>
<tr><td></td></tr>
...
<tr><td valign="top">E1-US04</td><td valign="top">` `Gestión de las notas por aula</td><td>T2</td><td valign="top">Sube las notas de un aula</td><td>Registrar y añadir las notas al aula</td><td>2</td><td>Andre</td><td valign="top">Done</td><td></td></tr>
<tr><td rowspan="2" valign="top">E4-US03</td><td rowspan="2" valign="top">Interfaz de Usuario Eficiente y Accesible</td><td>T1</td><td valign="top">Pantallas de registro e inicio de sesión</td><td>Diseñar e implementar el registro e inicio de sesión del usuario</td><td>1</td><td>Nelson</td><td valign="top">Done</td><td></td></tr>
...
<tr><td valign="top">bceec27e93267b3572aebab8a4428fae3acb6828</td><td valign="top">[feat: Added components, pages and the configuration](https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes-Front_End/commit/3e3732082651e02441d134520a5399c878fbed1a)</td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
<tr><td valign="top">297e80a10014e7f4e327e893047884102c71dd76</td><td valign="top">[feat: Teachers and students](https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes-Front_End/commit/b45e6921b5e59c6c8dafa51d89bada1f7e80a40c)</td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
<tr><td valign="top">38f7596295848c750b7e2c990433855280fbe13b</td><td valign="top"><p>feat: Take Attendance and grades</p><p></p></td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
<tr><td valign="top">2f8d6526777f29392583d16185770172e55cfa3b</td><td valign="top"><p>[Feature Equipment Finished](https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes-Front_End/commit/9f84a956d2fa2c63cd7cc2b9e4cf43a6a61ed86a)</p><p></p></td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
<tr><td valign="top">64ddec6293d5839ad0f0416a7d1ee1cf9f7dd21f</td><td valign="top"><p>[Fixing equipment and facilitites](https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes-Front_End/commit/a844b682c36fed396b34de15a085af0e3dff9225)</p><p></p></td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
<tr><td rowspan="5" valign="top"><p>RocketNotes FakeAPI</p><p></p></td><td rowspan="5" valign="top">main</td><td valign="top">b99351258a1cfaccadb96816c9497a624251da3c</td><td valign="top">[Initial commit](https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes-FakeAPI/commit/b99351258a1cfaccadb96816c9497a624251da3c)</td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
<tr><td valign="top">cafb69002761d229082d2e20d4798e3c5bdd518f</td><td valign="top">[Update README.md](https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes-FakeAPI/commit/cafb69002761d229082d2e20d4798e3c5bdd518f)</td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
<tr><td valign="top">5f4b17a9c71252351e0bda9b08708841378e5eb0</td><td valign="top">[Update db.json](https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes-FakeAPI/commit/5f4b17a9c71252351e0bda9b08708841378e5eb0)</td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
<tr><td valign="top">00f4401cf8d5867ef2c6e9c896d98e337cfa007b</td><td valign="top">[Update db.json](https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes-FakeAPI/commit/00f4401cf8d5867ef2c6e9c896d98e337cfa007b)</td><td valign="top"></td><td valign="top">03/05/2024</td></tr>
...
![](assets/Aspose.Words.47b49ff5-366e-410c-8228-c5a642d265c4.013.jpeg)

**Creación de clases:**

![](assets/Aspose.Words.47b49ff5-366e-410c-8228-c5a642d265c4.014.jpeg)

**Lista de estudiantes:**

![](assets/Aspose.Words.47b49ff5-366e-410c-8228-c5a642d265c4.015.jpeg)

Creación de curso:

![](assets/Aspose.Words.47b49ff5-366e-410c-8228-c5a642d265c4.016.jpeg)

Registro de asistencias:

![](assets/Aspose.Words.47b49ff5-366e-410c-8228-c5a642d265c4.017.jpeg)
...
![](assets/Aspose.Words.47b49ff5-366e-410c-8228-c5a642d265c4.021.png)
...
<table><tr><th colspan="2" valign="top"><b>Sprint #</b></th><th colspan="6" valign="top"><p></p><p><b>Sprint 3</b></p></th></tr>
<tr><td colspan="2" valign="top"><b>User Story</b></td><td colspan="6" valign="top"><p></p><p><b>Work-Item / Task</b></p></td></tr>
...
<tr><td rowspan="3" valign="top">E1-US01</td><td rowspan="3" valign="top"><p></p><p>Gestion del aforo de las aulas</p></td><td valign="top">T1</td><td valign="top">Crear aulas/salones</td><td valign="top">Desarrollar la funcionalidad de crear aulas por el admin</td><td valign="top">3</td><td rowspan="3" valign="top">Nelson</td><td rowspan="3" valign="top">Done</td></tr>
<tr><td valign="top"><p>T2</p><p></p></td><td valign="top"><p>Asignar capacidad de los aulas/salones</p><p></p></td><td rowspan="2" valign="top"><p>Desarrollar la funcionalidad de asignar capacidades de estudiantes por el admin</p><p>Implementar la funcionalidad de agregar estudiantes por su Id</p></td><td valign="top">4</td></tr>
<tr><td valign="top">T3</td><td valign="top">Agregar estudiantes al aula/salón</td><td valign="top">3</td></tr>
<tr><td valign="top">E1-US03</td><td valign="top"><p></p><p>Registro de asistencias</p></td><td valign="top">T1</td><td valign="top">Toma asistencia de un salón</td><td valign="top">Desarrollar dicha funcionalidad, para guardar una toma de asistencia</td><td valign="top">5</td><td valign="top">André</td><td valign="top">Done</td></tr>
<tr><td valign="top">E1-US04</td><td valign="top"><p></p><p>Gestión de las notas por aula</p></td><td valign="top">T1</td><td valign="top">Sube las notas de un salón </td><td valign="top">Desarrollar la función para guardar las notas de estudiantes</td><td valign="top">5</td><td valign="top">André</td><td valign="top">Done</td></tr>
<tr><td valign="top">E3-US05</td><td valign="top"><p></p><p>Control de inventario de útiles escolares</p></td><td valign="top">T1</td><td valign="top">Agregar la lista de útiles </td><td valign="top">Desarrollar la función de agregar útiles escolares.</td><td valign="top">3</td><td valign="top">Mateo</td><td valign="top">Done</td></tr>
<tr><td valign="top">E4-US09</td><td valign="top"><p></p><p>Optimización de las Asignacion de horarios y profesores</p></td><td valign="top">T1</td><td valign="top">Registrar un profesor al sistema en un horario asignable</td><td valign="top">Desarrollar la función crud de registrar al profesor con datos únicos</td><td valign="top">5</td><td valign="top">Nelson</td><td valign="top">To review</td></tr>
<tr><td rowspan="2" valign="top">E3-US12</td><td rowspan="2" valign="top"><p></p><p>Registro y gestión del mantenimiento de la infraestructura</p></td><td valign="top">T1</td><td valign="top">Agregar mantenimiento</td><td valign="top">Desarrollar la función para agregar un mantenimiento específico a la lista</td><td rowspan="2" valign="top">4</td><td rowspan="2" valign="top">Mateo</td><td rowspan="2" valign="top">Done</td></tr>
...
| :- | :- |:---------------------------------------| :- | :- | :- |
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 654c7abd21d771b6c6d27616f716a914c0567934|fix: AdminManagement - name controller||2024-06-10 00:18:20+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 0945d736e2289cd352dadca3c615f27d6ba6c5f7|fix -admin management controller||2024-06-10 00:10:53+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 4c4ef8d2f9df63f70386b507e5875a279b9b6451|Merge pull request #6 from RocketNotes-Open-Source-SW57-Grupo-3/feature/AdminManagment|<p></p><p>Feature/admin managment</p>|2024-06-09 22:35:50+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| ce50a5db0a6c7a99c8cd76a60553ed41a01a89cd|fix admin management: entities||2024-06-09 22:35:13+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 3010af5ad995f8a36809f2fed44c657b36086e41|chore(admins): fixing and updating different problems for admin features, create classroom and student||2024-06-09 19:55:49+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| fc656494dff9faba0fa3ff3d604d16b94dbbb62f|feat(admins): added new command services, delete a course and remove students||2024-06-09 19:54:44+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| efb7830b8ecc16fd487340fc622375fddc6f6692|feat(admins): added new resources for admin, classroom||2024-06-09 19:53:51+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 0dabcf71e3880f119256d83c5f3d18693ca701dc|feat(admins): fixing and updating course features||2024-06-09 19:50:27+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 1590bc1991d8d5dffeb659839defac3763d56070|feat(admins): fixing and updating classroom features||2024-06-09 19:49:37+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 0de7dfe776f80a700d989717f161a33f7ff3e683|feat(admins): fixing and updating admin features||2024-06-09 19:49:09+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| e969acf81b2e4db31bcb1fc04c21092364db8d45|feat(admins): added news command services and resources for classroom and students||2024-06-09 19:48:30+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 05b49baac419a62db1eedd5e99725fc18419941a|feat(admins): fixing multiples problems of admin files||2024-06-09 05:01:22+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 1d9fa95a4840f02cfef915731ad9070aa4fe7451|update password config for mysql connection||2024-06-09 03:38:45+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| d08fe30233e62285a068566402842d4ad6f8017b|chore(admins): update aggregates||2024-06-09 03:24:09+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 44644b629e98b7b0ac5a12934bc4e9280299c759|chore(admins): update value objects||2024-06-09 03:23:53+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| aca961371ceabcfd235381c32fb217d5cef4fef7|chore(admins): update new data||2024-06-09 03:23:25+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 8c33f69d90c8dc6006299e538e59e43af9dc7f94|feat(admins): added new value objects||2024-06-09 02:32:40+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| c920259a19cbf4a4501a5a8e48f1a6dd1b08f9d2|feat(admins): added new queries||2024-06-09 02:31:48+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 2bea85df72bf051f81cc873534c6d1ed49601fb2|feat(admins): added new aggregates for the entities||2024-06-09 02:30:58+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 7a36bbe8d229667889219110b6a9b5155c3513fc|feat(admins): added new commands||2024-06-09 02:30:29+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 5a189d7db70525da9ccbda6824bb353e3597a6a2|chore(admins): update teacher data||2024-06-09 02:07:26+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 874d3e2a4fd114a93a96945b8d05d072baba1b3b|chore: fix audi||2024-06-08 06:25:42+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 1d47034d765caf0cf4327435637d1da4380234ea|Update RocketnotesApplicationTests.java||2024-06-08 06:24:14+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 1aeb00cdc5ea679475d494a51d5054bcfd730c03|chore: fix auditable||2024-06-08 06:17:24+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 63c3b2103c7b14beeca2ce2309848feeb337abce|fix Profile feature|<p></p><p>fix profile feature</p>|2024-06-08 06:05:04+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| f65b4e64543ee198edfbdd274c07a3feb2444287|Merge pull request #5 from RocketNotes-Open-Source-SW57-Grupo-3/feature/ProfileServiceManagement|<p></p><p>Feature/profile service management</p>|2024-06-08 05:32:35+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 75fc1c3c7909377447711b882fe4394f272df4e4|Merge branch 'develop' into feature/ProfileServiceManagement||2024-06-08 05:32:16+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 4acaff11ac0b2625d9bacaf5b1e0f232f30eee3f|fix(profiles): fixed||2024-06-08 05:19:01+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 593e352093479482c6712796bc3f11cd5334a6ae|Merge pull request #4 from RocketNotes-Open-Source-SW57-Grupo-3/feature/AdminManagment|<p></p><p>Feature/admin managment</p>|2024-06-08 04:57:19+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| bbd9580b167d54fd3fb9906083f15290b84b716f|Merge pull request #3 from RocketNotes-Open-Source-SW57-Grupo-3/feature/AttendanceAndGrades|<p></p><p>Feature/attendance and grades</p>|2024-06-08 04:56:44+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 398703e2c370562d0765dd2d609b19b192b3edf0|feat(profiles): added unversioned files||2024-06-08 04:54:27+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 9ff8f42067e012ee68a483859bfe1215a7d95385|feat(profiles): added rest profile controller||2024-06-08 04:53:24+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| e4ede7adb7fff1bd0f37c6380b59ab1b889f0df4|feat(profiles): added rest transform||2024-06-08 04:53:05+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 6775bf69edfe6bc553787cb4986c499ef8c5ae4f|feat(profiles): added shared and pom configuration||2024-06-08 04:52:17+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 19ca78a2b0532fb8870ec54597aa0f56c0b338cc|feat(profiles): added query service implementation||2024-06-08 04:00:54+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| d889809a280b6b0c26e8cb91c577a76af734bc02|feat(profiles): added profile outbound service||2024-06-08 03:47:00+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 76889af4bf3bb79f28ff8644486c31a33a8acae7|feat(profiles): added command queries and service contracts in domain||2024-06-08 03:41:07+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| d987a549b67bc14b253095dab2a3d269c7decd72|feat(profiles): added aggregate create profile command handling at root level||2024-06-08 03:32:41+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| e6870105c286a32c08a41f8bb9bb6f103b6e5c91|fix(Profile): Eliminated unnecessary code||2024-06-08 02:27:42+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 3372d1b491ca5e53141f507c77650eda9aa68456|feat(profile): added Profile aggregate||2024-06-08 02:23:45+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| c8a92916e898b7b0d6d7ce83520304aa9e0262bb|feat(profiles): added value objets in domain||2024-06-08 01:58:30+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| a29e5067ee8f4c935842dd6d3fb283130445f133|chore(admins): update teacher data||2024-06-08 01:29:19+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 6a6f06679134a8a1b531e3bb7f356337458bfd9f|feat(admins): added controllers with endpoints to manage CRUD operations for their respective entities||2024-06-08 00:50:10+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 30f3f49ebde9dd24b1a7c7f1ff86f99bc7d1ee78|feat(admins): added but just declared new repositories||2024-06-08 00:49:20+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| ce18528265d9ef218622d5258d6085542de550e8|feat(admins): added new services to manage the entities||2024-06-08 00:48:06+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 7f64db176f1e129e26dfe7ad043bb22583cb9bbb|feat(admins): added new entities for admin managment||2024-06-08 00:46:26+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| cdfd62e6b498fa62951b412f3fa81a165989a12c|fix: issues solves with dependencies||2024-06-07 09:59:06+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 48339b96cfb762efa7e246bacd3d9c6951b6fa7f|feat: Added controllers in interfaces||2024-06-07 09:58:40+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 7f67ae5a19ad6a38dbd741c67e141a9d9066a3e5|feat: add classes to the layer transform||2024-06-07 09:58:14+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| f08918e76438ce336fda7449f7c55540cdbeb7d8|feat: added to the layer internal application commandservices and queryservices||2024-06-07 09:57:34+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 04b10002592c02b092747fa30922b4840ef8a2aa|feat: added layer resources||2024-06-07 09:56:30+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| f578f55b64fc59a1e4e12b85840874542f03eb46|feat: added repositories for attendances and grades||2024-06-07 09:55:46+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| dd2c5cff0de46c4db3595d6e7fd223e5f3c80478|feat: added services for attendances and grades||2024-06-07 09:55:26+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 1b65314425cb29df458bfb587b1665df545108cb|feat: added queries related to students and courses||2024-06-07 09:54:15+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 3ff397ccbf9abd17cc1e022e32b391c5dfaa3aa8|feat: added commands related to students and courses||2024-06-07 09:53:51+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| b47855bd00909abc7ed7495960df7e9e8bd5fe98|feat: added aggregates related to students and courses||2024-06-07 09:52:52+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| b8bfe87d9abcecacdb2ca82bf0011cf2d636f6b3|feat: added valueobjects related to students and courses||2024-06-07 09:49:55+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 0efb17ad4b194a7295bf32aa4e79c78a3f536225|feat: added valueobjects related to students and courses||2024-06-07 09:48:42+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| dae04b0fb0255f0978638eef838d1d0dcab476f6|feat: add entities to bounded context Attendance And Grades||2024-06-06 06:11:25+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 30c0d5533da49fc2ba2f8b2f3e00402ba943f95d|Merge pull request #1 from RocketNotes-Open-Source-SW57-Grupo-3/feature/facilitesAndEquipments|<p></p><p>feat: Maintenance</p>|2024-06-04 05:43:16+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 709a31bf9d3910e3c046db6386d3f1a84fd2fcdc|feat: Maintenance|<p></p><p>En este commit, se han agregado nuevos endpoints para equipments y facilities, ampliando la funcionalidad del repositorio.</p>|2024-06-04 05:42:53+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 212960a1c40bab8b52c0d7b304a083bf0fb3d7b2|Merge branch 'main' of https://github.com/RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend||2024-06-03 06:05:46+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 25c8c460134158d4f4885994f783c7430f31759c|update giignore|<p></p><p>update files</p>|2024-06-03 06:04:57+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| ca6aaf38f4058759119a7d7f80a9c5d344ae67b2|Update .gitignore||2024-06-03 05:57:49+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| f18cbaba534a844dd1fd584b70316c25a4cf1de1|Update .gitignore||2024-06-03 05:56:55+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 6efb87ca756a3a15c401872ceb36efe6e64e41e2|first commit|<p></p><p>first commit adding directories</p>|2024-06-03 05:46:51+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 8c1023b49b979f16ed203485aabec9da3065d447|Create .gitignore||2024-06-03 05:21:31+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 654c7abd21d771b6c6d27616f716a914c0567934|fix: AdminManagement - name controller||2024-06-10 00:18:20+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 0945d736e2289cd352dadca3c615f27d6ba6c5f7|fix -admin management controller||2024-06-10 00:10:53+00:00|
|RocketNotes-Open-Source-SW57-Grupo-3/RocketNotes\_Backend|develop| 4c4ef8d2f9df63f70386b507e5875a279b9b6451|Merge pull request #6 from RocketNotes-Open-Source-SW57-Grupo-3/feature/AdminManagment|<p></p><p>Feature/admin managment</p>|2024-06-09 22:35:50+00:00|
