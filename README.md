...
|Serrano Ircañaupa, Nelson Elías| U202214733 |
...
| :-: | :-: | :-: | :-: |
|#01|08/04/2024|Todos los participantes|Elaboración de los capítulos: I, II, III, IV y V|

### **Student Outcome**

|**Criterio Específico**|**Acciones Realizadas**|**Conclusiones**|
| :- | :- | :- |
|La capacidad de identificar, formular y resolver problemas complejos de ingeniería aplicando los principios de ingeniería, ciencia y matemática.|<p>**Mateo Vilchez Rios**</p><p></p><p>**TB1**<br>En esta etapa del proyecto de ingeniería, comuniqué eficazmente ajustes y hallazgos clave a un público diverso, tras realizar impact mapping y needfinding. Adapté nuestras estrategias para reflejar estas revisiones, asegurando comprensión y cohesión en el equipo, y promoviendo una ejecución alineada y efectiva del proyecto.</p><p></p><p>**Belen Ramos Rios**</p><p></p><p>**TB1**</p><p>Tras aplicar Lean UX Canvas, realizar entrevistas y definir User Personas, comuniqué estrategias y ajustes claves al equipo y stakeholders, asegurando alineación y adaptabilidad en nuestro proyecto de ingeniería, facilitando así una ejecución cohesiva y orientada al usuario.</p><p></p><p>**Frida Dam Rubianes**</p><p></p><p>**TB1**</p><p>Durante el desarrollo del proyecto realizamos un análisis profundo del problema y buscamos soluciones enfocadas en la aplicación de principios de ingeniería. El análisis incluyó una correcta identificación y formulación del problema.</p><p></p><p>**Nelson Elías Serrano Ircañaupa**</p><p></p><p>**TB1**</p><p>Se realizaron investigaciones de mercado para encontrar competidores que ofrecieran similares características que nuestro producto y en base a ello se analizaron las diferentes tácticas y estrategias para afrontarlas. Luego se realizó el Product backlog ordenando y gestionando las historias de usuario según su valor para el negocio.</p><p></p><p>**André La Torre Soto**</p><p></p><p>**TB1:**</p><p>Se analizó las entrevistas proporcionadas por nuestros segmentos objetivos para poder desarrollar el needfinding, creando las User Personas utilizadas en la elaboración de los puntos siguientes los cuales nos ayudaron a entender de forma completa las necesidades de nuestros futuros usuarios.</p><p><br><br></p>|<p>**TB1**</p><p>En este proyecto de ingeniería, cada integrante ha demostrado una aplicación meticulosa de diversas técnicas para una comprensión profunda del problema y sus soluciones. Desde el impact mapping y Lean UX Canvas hasta el análisis competitivo y needfinding, las estrategias empleadas han permitido una alineación precisa entre las necesidades de los usuarios y los objetivos empresariales. La comunicación clara de ajustes y hallazgos ha asegurado la cohesión y comprensión del equipo, promoviendo una ejecución efectiva y adaptativa. Este enfoque integrado ha optimizado la gestión del proyecto, destacando la importancia de la adaptabilidad y la orientación al usuario en el proceso de ingeniería.</p>|
|Elaborar una propuesta de solución a una problemática o lograr mejora de una solución ya existente a través de la innovación.** |<p>**Mateo Vilchez Rios**</p><p></p><p>**TB1:** En esta etapa del proyecto, identifiqué una problemática central en la interacción usuario-sistema, proponiendo una innovadora solución de interfaz gráfica. Esta propuesta se basa en el uso de tecnologías emergentes para mejorar la accesibilidad y la experiencia del usuario. La solución fue validada mediante prototipos de alta fidelidad, sometidos a pruebas de usabilidad que demostraron una mejora significativa en la eficiencia y satisfacción de los usuarios.</p><p></p><p>**Belen Ramos Rios**</p><p></p><p>**TB1:** Mi contribución se centró en la identificación de una brecha en la experiencia de usuario dentro de nuestro sistema actual. Diseñe una solución innovadora que involucra una plataforma colaborativa que facilita la interacción entre los usuarios y el sistema, promoviendo un enfoque más personalizado y dinámico. Esta solución se validó a través de iteraciones de diseño centradas en el usuario, mejorando significativamente la engagement y la retención de usuarios.</p><p></p><p>**Frida Sofía Dam Rubianes**</p><p></p><p>**TB1:** Durante el desarrollo del proyecto identificamos una problemática real implementando diversas técnicas. Nuestro objetivo fue encontrar la mejor forma de resolver los inconvenientes aplicando elementos innovadores dentro de la aplicación web que desarrollaremos.</p><p></p><p>**Nelson Elías Serrano Ircañaupa**</p><p></p><p>**TB1:** Para la propuesta de la solución se siguió el enfoque del Domain Driven Design(DDD), empleando los patrones de software requeridos. Para los esquemas se realizaron el diagrama de contexto, contenedores y componentes. Además, se implementó y desplegó el diseño principal de la landing page.</p><p></p><p>**André La Torre Soto**</p><p>**TB1:**</p><p></p><p>En esta fase del proyecto, tras analizar las entrevistas con nuestros segmentos objetivos, identifiqué desafíos clave en la comprensión de las necesidades de los usuarios. A partir de este análisis, propuse una solución basada en la creación de User Personas detalladas. Permitiéndonos comprender integralmente las necesidades de nuestros futuros usuarios y, así, enfocarnos en la innovación dirigida y efectiva de nuestros desarrollos.</p><p><br></p>|<p>**TB1**</p><p>En este proyecto, cada integrante del equipo ha contribuido con soluciones innovadoras para abordar desafíos específicos en la interacción usuario-sistema. Desde la implementación de interfaces gráficas avanzadas y plataformas colaborativas hasta la adopción de Domain Driven Design y la creación de User Personas, las estrategias utilizadas se han centrado en mejorar la accesibilidad, la experiencia del usuario y la personalización del sistema. Estas soluciones se validaron mediante prototipos y pruebas de usabilidad, asegurando que los desarrollos no solo sean innovadores sino también efectivamente alineados con las necesidades reales de los usuarios, lo que ha resultado en una mejora notable en la eficiencia, satisfacción y engagement de los usuarios.</p>|
